...
export interface EtfAddressMap {
...
export interface EtfQueryFundPriceResponse {
  price?: EtfFundPrice;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/defund-labs/defund/etf/fund
   */
  queryFundAll = (
    query?: {
    ...
    this.request<EtfQueryAllFundResponse, RpcStatus>({
      path: `/defund-labs/defund/etf/fund`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name QueryFund
   * @summary Queries a fund by symbol.
   * @request GET:/defund-labs/defund/etf/fund/{symbol}
   */
  queryFund = (symbol: string, params: RequestParams = {}) =>
    this.request<EtfQueryGetFundResponse, RpcStatus>({
      path: `/defund-labs/defund/etf/fund/${symbol}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/defund-labs/defund/etf/fundPrice
   */
