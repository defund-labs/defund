...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
  ...
  sed -i 's/timeout_prevote =.*/timeout_prevote = "200ms"/g' $CONFIG_PATH
  sed -i 's/timeout_precommit =.*/timeout_precommit = "200ms"/g' $CONFIG_PATH
  sed -i 's/timeout_commit =.*/timeout_commit = "200ms"/g' $CONFIG_PATH
  ...
  printf "\t timeout_prevote = \"200ms\"\n"
  printf "\t timeout_precommit = \"200ms\"\n"
  printf "\t timeout_commit = \"200ms\"\n"
