...
func FillOrder(order Order, amt sdk.Int, price sdk.LegacyDec) (quoteCoinDiff sdk.Int) {
...
func FulfillOrder(order Order, price sdk.LegacyDec) (quoteCoinDiff sdk.Int) {
...
// at given price.
func FulfillOrders(orders []Order, price sdk.LegacyDec) (quoteCoinDiff sdk.Int) {
	quoteCoinDiff = sdk.ZeroInt()
...
func FindMatchPrice(ov OrderView, tickPrec int) (matchPrice sdk.LegacyDec, found bool) {
...
func (ob *OrderBook) FindMatchableAmountAtSinglePrice(matchPrice sdk.LegacyDec) (matchableAmt sdk.Int, found bool) {
	type Side struct {
		ticks             []*orderBookTick
...
// at the price.
func (ob *OrderBook) MatchAtSinglePrice(matchPrice sdk.LegacyDec) (quoteCoinDiff sdk.Int, matched bool) {
...
func (ob *OrderBook) PriceDirection(lastPrice sdk.LegacyDec) PriceDirection {
...
func (ob *OrderBook) Match(lastPrice sdk.LegacyDec) (matchPrice sdk.LegacyDec, quoteCoinDiff sdk.Int, matched bool) {
	if len(ob.buys.ticks) == 0 || len(ob.sells.ticks) == 0 {
		return sdk.LegacyDec{}, sdk.Int{}, false
	}
...
func DistributeOrderAmountToTick(tick *orderBookTick, amt sdk.Int, price sdk.LegacyDec) (quoteCoinDiff sdk.Int) {
	remainingAmt := amt
	quoteCoinDiff = sdk.ZeroInt()
...
func DistributeOrderAmountToOrders(orders []Order, amt sdk.Int, price sdk.LegacyDec) (quoteCoinDiff sdk.Int) {
