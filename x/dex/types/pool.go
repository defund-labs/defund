...
func NewRangedPool(id, pairId uint64, creator sdk.AccAddress, minPrice, maxPrice math.LegacyDec) Pool {
	return Pool{
		Type:                  PoolTypeRanged,
		Id:                    id,
		PairId:                pairId,
...
func (orderer *PoolOrderer) Order(dir amm.OrderDirection, price math.LegacyDec, amt math.Int) amm.Order {
