...
func (PoolType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_de6d612725ab3a2c, []int{0}
}
...
func (OrderType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_de6d612725ab3a2c, []int{1}
}
...
func (OrderDirection) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_de6d612725ab3a2c, []int{2}
}
...
func (RequestStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_de6d612725ab3a2c, []int{3}
}
...
func (OrderStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_de6d612725ab3a2c, []int{4}
}
...
func (m *Pair) GetBaseCoinDenom() string {
	if m != nil {
...
func (m *Pair) GetQuoteCoinDenom() string {
	if m != nil {
...
func (m *Pair) GetEscrowAddress() string {
	if m != nil {
...
func (m *Pair) GetLastOrderId() uint64 {
	if m != nil {
...
func (m *Pair) GetCurrentBatchId() uint64 {
	if m != nil {
...
func (m *Pool) GetReserveAddress() string {
	if m != nil {
...
func (m *Pool) GetPoolCoinDenom() string {
	if m != nil {
...
func (m *Pool) GetLastDepositRequestId() uint64 {
	if m != nil {
...
func (m *Pool) GetLastWithdrawRequestId() uint64 {
	if m != nil {
...
func (m *DepositRequest) GetId() uint64 {
	if m != nil {
		return m.Id
	}
	return 0
...
func (m *DepositRequest) GetPoolId() uint64 {
	if m != nil {
		return m.PoolId
	}
	return 0
...
func (m *DepositRequest) GetMsgHeight() int64 {
	if m != nil {
		return m.MsgHeight
	}
	return 0
...
func (m *DepositRequest) GetDepositor() string {
	if m != nil {
		return m.Depositor
	}
	return ""
...
func (m *DepositRequest) GetDepositCoins() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
...
func (m *DepositRequest) GetAcceptedCoins() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
...
func (m *DepositRequest) GetMintedPoolCoin() types.Coin {
	if m != nil {
		return m.MintedPoolCoin
	}
	return types.Coin{}
}

func (m *DepositRequest) GetStatus() RequestStatus {
	if m != nil {
		return m.Status
	}
...
func (m *WithdrawRequest) GetId() uint64 {
	if m != nil {
		return m.Id
	}
	return 0
...
func (m *WithdrawRequest) GetPoolId() uint64 {
	if m != nil {
		return m.PoolId
	}
	return 0
...
func (m *WithdrawRequest) GetMsgHeight() int64 {
	if m != nil {
		return m.MsgHeight
	}
	return 0
...
func (m *WithdrawRequest) GetWithdrawer() string {
	if m != nil {
		return m.Withdrawer
	}
	return ""
...
func (m *WithdrawRequest) GetPoolCoin() types.Coin {
	if m != nil {
		return m.PoolCoin
	}
	return types.Coin{}
...
func (m *WithdrawRequest) GetWithdrawnCoins() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
...
func (m *WithdrawRequest) GetStatus() RequestStatus {
	if m != nil {
		return m.Status
	}
	return RequestStatusUnspecified
...
type Order struct {
	...
	Type OrderType `protobuf:"varint,1,opt,name=type,proto3,enum=defund.dex.OrderType" json:"type,omitempty"`
...
func (m *Order) GetMsgHeight() int64 {
	if m != nil {
		return m.MsgHeight
	}
	return 0
...
func (m *Order) GetOrderer() string {
	if m != nil {
		return m.Orderer
	}
	return ""
...
func (m *Order) GetOfferCoin() types.Coin {
	if m != nil {
		return m.OfferCoin
	}
	return types.Coin{}
...
func (m *Order) GetRemainingOfferCoin() types.Coin {
	if m != nil {
...
func (m *Order) GetReceivedCoin() types.Coin {
	if m != nil {
		return m.ReceivedCoin
	}
	return types.Coin{}
}
...
func (m *Order) GetExpireAt() time.Time {
	if m != nil {
		return m.ExpireAt
	}
	return time.Time{}
...
func init() {
	proto.RegisterEnum("defund.dex.PoolType", PoolType_name, PoolType_value)
	proto.RegisterEnum("defund.dex.OrderType", OrderType_name, OrderType_value)
	proto.RegisterEnum("defund.dex.OrderDirection", OrderDirection_name, OrderDirection_value)
	proto.RegisterEnum("defund.dex.RequestStatus", RequestStatus_name, RequestStatus_value)
	proto.RegisterEnum("defund.dex.OrderStatus", OrderStatus_name, OrderStatus_value)
	proto.RegisterType((*Pair)(nil), "defund.dex.Pair")
	proto.RegisterType((*Pool)(nil), "defund.dex.Pool")
	proto.RegisterType((*DepositRequest)(nil), "defund.dex.DepositRequest")
	proto.RegisterType((*WithdrawRequest)(nil), "defund.dex.WithdrawRequest")
	proto.RegisterType((*Order)(nil), "defund.dex.Order")
}

func init() { proto.RegisterFile("defund/dex/dex.proto", fileDescriptor_de6d612725ab3a2c) }

var fileDescriptor_de6d612725ab3a2c = []byte{
	// 1579 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Pair) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CurrentBatchId != 0 {
		i = encodeVarintDex(dAtA, i, uint64(m.CurrentBatchId))
		i--
		dAtA[i] = 0x38
	}
	if m.LastPrice != nil {
	...
	if m.LastOrderId != 0 {
		i = encodeVarintDex(dAtA, i, uint64(m.LastOrderId))
		i--
		dAtA[i] = 0x28
	}
	if len(m.EscrowAddress) > 0 {
		...
		i = encodeVarintDex(dAtA, i, uint64(len(m.EscrowAddress)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.QuoteCoinDenom) > 0 {
		...
		i = encodeVarintDex(dAtA, i, uint64(len(m.QuoteCoinDenom)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.BaseCoinDenom) > 0 {
		...
		i = encodeVarintDex(dAtA, i, uint64(len(m.BaseCoinDenom)))
		i--
		dAtA[i] = 0x12
	}
	if m.Id != 0 {
...
func (m *Pool) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LastWithdrawRequestId != 0 {
		i = encodeVarintDex(dAtA, i, uint64(m.LastWithdrawRequestId))
		i--
		dAtA[i] = 0x50
	}
	if m.LastDepositRequestId != 0 {
		i = encodeVarintDex(dAtA, i, uint64(m.LastDepositRequestId))
		i--
		dAtA[i] = 0x48
	}
	if m.MaxPrice != nil {
	...
	if len(m.PoolCoinDenom) > 0 {
		...
		i = encodeVarintDex(dAtA, i, uint64(len(m.PoolCoinDenom)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.ReserveAddress) > 0 {
		...
		i = encodeVarintDex(dAtA, i, uint64(len(m.ReserveAddress)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Creator) > 0 {
	...
	if m.PairId != 0 {
		i = encodeVarintDex(dAtA, i, uint64(m.PairId))
		i--
		dAtA[i] = 0x18
	}
	if m.Id != 0 {
	...
	if m.Type != 0 {
		i = encodeVarintDex(dAtA, i, uint64(m.Type))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *DepositRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.MsgHeight != 0 {
		i = encodeVarintDex(dAtA, i, uint64(m.MsgHeight))
		i--
		dAtA[i] = 0x18
	}
	if m.PoolId != 0 {
...
func (m *WithdrawRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Withdrawer) > 0 {
		...
		i = encodeVarintDex(dAtA, i, uint64(len(m.Withdrawer)))
		i--
		dAtA[i] = 0x22
	}
	if m.MsgHeight != 0 {
...
func (m *Order) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i -= n3
	i = encodeVarintDex(dAtA, i, uint64(n3))
	i--
	dAtA[i] = 0x72
	if m.BatchId != 0 {
		i = encodeVarintDex(dAtA, i, uint64(m.BatchId))
		i--
		dAtA[i] = 0x68
	}
	{
	...
	dAtA[i] = 0x3a
	if m.Direction != 0 {
		i = encodeVarintDex(dAtA, i, uint64(m.Direction))
		i--
		dAtA[i] = 0x30
	}
	if len(m.Orderer) > 0 {
		...
		i = encodeVarintDex(dAtA, i, uint64(len(m.Orderer)))
		i--
		dAtA[i] = 0x2a
	}
	if m.MsgHeight != 0 {
...
func (m *Pair) Size() (n int) {
	...
	if m.LastOrderId != 0 {
		n += 1 + sovDex(uint64(m.LastOrderId))
	}
	if m.LastPrice != nil {
		l = m.LastPrice.Size()
		n += 1 + l + sovDex(uint64(l))
	...
	if m.CurrentBatchId != 0 {
		n += 1 + sovDex(uint64(m.CurrentBatchId))
	}
	return n
}
...
func (m *Pool) Size() (n int) {
	...
	_ = l
	if m.Type != 0 {
		n += 1 + sovDex(uint64(m.Type))
	}
	if m.Id != 0 {
		n += 1 + sovDex(uint64(m.Id))
	}
	if m.PairId != 0 {
		n += 1 + sovDex(uint64(m.PairId))
	}
	l = len(m.Creator)
	if l > 0 {
		n += 1 + l + sovDex(uint64(l))
	...
	if m.LastDepositRequestId != 0 {
		n += 1 + sovDex(uint64(m.LastDepositRequestId))
	}
	if m.LastWithdrawRequestId != 0 {
		n += 1 + sovDex(uint64(m.LastWithdrawRequestId))
	}
	if m.Disabled {
		n += 2
	}
