...
func init() {
	proto.RegisterType((*GenesisState)(nil), "defund.liquidity.v1beta1.GenesisState")
	proto.RegisterType((*NumMMOrdersRecord)(nil), "defund.liquidity.v1beta1.NumMMOrdersRecord")
}

func init() {
	proto.RegisterFile("defund/liquidity/v1beta1/genesis.proto", fileDescriptor_6a6239844d27c73b)
}
