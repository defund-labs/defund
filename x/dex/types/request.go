...
func NewOrderForLimitOrder(msg *MsgLimitOrder, id uint64, pair Pair, offerCoin sdk.Coin, price math.LegacyDec, expireAt time.Time, msgHeight int64) Order {
	return Order{
		Type:               OrderTypeLimit,
		Id:                 id,
		PairId:             pair.Id,
...
func NewOrderForMarketOrder(msg *MsgMarketOrder, id uint64, pair Pair, offerCoin sdk.Coin, price math.LegacyDec, expireAt time.Time, msgHeight int64) Order {
	return Order{
...
func NewOrder(
	...
	offerCoin sdk.Coin, price math.LegacyDec, amt math.Int, expireAt time.Time, msgHeight int64) Order {
	var (
		dir             OrderDirection
