...
var (
	...
	ErrUnmarshallJson         = sdkerrors.Register(ModuleName, 13, "JSON unmarshalling error")
	ErrEncodingBroker         = sdkerrors.Register(ModuleName, 14, "error encoding broker")
	ErrEncodingBrokers        = sdkerrors.Register(ModuleName, 15, "error encoding brokers")
	ErrEncodingBrokerAddress  = sdkerrors.Register(ModuleName, 16, "error encoding broker address")
	ErrUnknownQuery           = sdkerrors.Register(ModuleName, 17, "error unknown query")
)
