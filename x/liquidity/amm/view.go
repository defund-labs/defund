...
func (view *OrderBookView) HighestBuyPrice() (sdk.LegacyDec, bool) {
	if len(view.buyAmtAccSums) == 0 {
		return sdk.LegacyDec{}, false
	}
...
func (view *OrderBookView) LowestSellPrice() (sdk.LegacyDec, bool) {
...
func (view *OrderBookView) BuyAmountOver(price sdk.LegacyDec, inclusive bool) sdk.Int {
	i := sort.Search(len(view.buyAmtAccSums), func(i int) bool {
		if inclusive {
...
func (view *OrderBookView) BuyAmountUnder(price sdk.LegacyDec, inclusive bool) sdk.Int {
	i := sort.Search(len(view.buyAmtAccSums), func(i int) bool {
		if inclusive {
			return view.buyAmtAccSums[i].price.LTE(price)
		} else {
...
func (view *OrderBookView) SellAmountUnder(price sdk.LegacyDec, inclusive bool) sdk.Int {
	i := sort.Search(len(view.sellAmtAccSums), func(i int) bool {
		if inclusive {
...
func (view *OrderBookView) SellAmountOver(price sdk.LegacyDec, inclusive bool) sdk.Int {
	i := sort.Search(len(view.sellAmtAccSums), func(i int) bool {
		if inclusive {
			return view.sellAmtAccSums[i].price.GTE(price)
		} else {
...
func (views MultipleOrderViews) HighestBuyPrice() (price sdk.LegacyDec, found bool) {
...
func (views MultipleOrderViews) LowestSellPrice() (price sdk.LegacyDec, found bool) {
	for _, view := range views {
...
func (views MultipleOrderViews) BuyAmountOver(price sdk.LegacyDec, inclusive bool) sdk.Int {
	amt := sdk.ZeroInt()
	for _, view := range views {
...
func (views MultipleOrderViews) SellAmountUnder(price sdk.LegacyDec, inclusive bool) sdk.Int {
	amt := sdk.ZeroInt()
	for _, view := range views {
