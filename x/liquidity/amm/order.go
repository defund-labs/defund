...
type Orderer interface {
	Order(dir OrderDirection, price sdk.LegacyDec, amt sdk.Int) Order
}
...
func (orderer BaseOrderer) Order(dir OrderDirection, price sdk.LegacyDec, amt sdk.Int) Order {
...
func NewBaseOrder(dir OrderDirection, price sdk.LegacyDec, amt, offerCoinAmt sdk.Int) *BaseOrder {
	return &BaseOrder{
		Direction:                dir,
		Price:                    price,
		Amount:                   amt,
...
func (order *BaseOrder) GetPrice() sdk.LegacyDec {
	return order.Price
}
