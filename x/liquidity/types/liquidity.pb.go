...
type Order struct {
	...
	Type OrderType `protobuf:"varint,1,opt,name=type,proto3,enum=defund.liquidity.v1beta1.OrderType" json:"type,omitempty"`
...
func init() {
	proto.RegisterEnum("defund.liquidity.v1beta1.PoolType", PoolType_name, PoolType_value)
	proto.RegisterEnum("defund.liquidity.v1beta1.OrderType", OrderType_name, OrderType_value)
	proto.RegisterEnum("defund.liquidity.v1beta1.OrderDirection", OrderDirection_name, OrderDirection_value)
	proto.RegisterEnum("defund.liquidity.v1beta1.RequestStatus", RequestStatus_name, RequestStatus_value)
	proto.RegisterEnum("defund.liquidity.v1beta1.OrderStatus", OrderStatus_name, OrderStatus_value)
	proto.RegisterType((*Params)(nil), "defund.liquidity.v1beta1.Params")
	proto.RegisterType((*Pair)(nil), "defund.liquidity.v1beta1.Pair")
	proto.RegisterType((*Pool)(nil), "defund.liquidity.v1beta1.Pool")
	proto.RegisterType((*DepositRequest)(nil), "defund.liquidity.v1beta1.DepositRequest")
	proto.RegisterType((*WithdrawRequest)(nil), "defund.liquidity.v1beta1.WithdrawRequest")
	proto.RegisterType((*Order)(nil), "defund.liquidity.v1beta1.Order")
}

func init() {
	proto.RegisterFile("defund/liquidity/v1beta1/liquidity.proto", fileDescriptor_c9be4f53a63dce2f)
}
