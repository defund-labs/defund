...
func TestParams_Validate(t *testing.T) {
	for _, tc := range []struct {
		...
		},
		{
			...
			func(params *types.Params) {
				params.MinInitialPoolCoinSupply = math.ZeroInt()
			},
		...
		},
		{
			...
			func(params *types.Params) {
				params.PairCreationFee = sdk.Coins{sdk.Coin{Denom: sdk.DefaultBondDenom, Amount: math.ZeroInt()}}
			},
		...
		},
		{
			...
			func(params *types.Params) {
				params.PoolCreationFee = sdk.Coins{sdk.Coin{Denom: sdk.DefaultBondDenom, Amount: math.ZeroInt()}}
			},
		...
		},
		{
			...
			func(params *types.Params) {
				params.MaxPriceLimitRatio = math.LegacyNewDec(-1)
			},
