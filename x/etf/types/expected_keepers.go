...
type BrokerKeeper interface {
	...
	SetCreate(ctx sdk.Context, transfer brokertypes.Create)
	GetAllCreate(ctx sdk.Context) (list []brokertypes.Create)
	GetAllCreateWithDep(ctx sdk.Context, queryId string, status string) (list []brokertypes.Create)
	GetCreate(ctx sdk.Context, index string) (val brokertypes.Create, found bool)
	RemoveCreate(ctx sdk.Context, id string)
