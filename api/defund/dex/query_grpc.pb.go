...
const (
	Query_Params_FullMethodName               = "/defund.dex.Query/Params"
	Query_Pools_FullMethodName                = "/defund.dex.Query/Pools"
	Query_Pool_FullMethodName                 = "/defund.dex.Query/Pool"
	Query_PoolByReserveAddress_FullMethodName = "/defund.dex.Query/PoolByReserveAddress"
	Query_PoolByPoolCoinDenom_FullMethodName  = "/defund.dex.Query/PoolByPoolCoinDenom"
	Query_Pairs_FullMethodName                = "/defund.dex.Query/Pairs"
	Query_Pair_FullMethodName                 = "/defund.dex.Query/Pair"
	Query_DepositRequests_FullMethodName      = "/defund.dex.Query/DepositRequests"
	Query_DepositRequest_FullMethodName       = "/defund.dex.Query/DepositRequest"
	Query_WithdrawRequests_FullMethodName     = "/defund.dex.Query/WithdrawRequests"
	Query_WithdrawRequest_FullMethodName      = "/defund.dex.Query/WithdrawRequest"
	Query_Orders_FullMethodName               = "/defund.dex.Query/Orders"
	Query_Order_FullMethodName                = "/defund.dex.Query/Order"
	Query_OrdersByOrderer_FullMethodName      = "/defund.dex.Query/OrdersByOrderer"
	Query_OrderBooks_FullMethodName           = "/defund.dex.Query/OrderBooks"
	Query_NumMMOrders_FullMethodName          = "/defund.dex.Query/NumMMOrders"
)
