...
import IbcGoV4IbcApplicationsTransferV1 from './ibc-go/v4/ibc.applications.transfer.v1'
import IbcGoV4IbcCoreChannelV1 from './ibc-go/v4/ibc.core.channel.v1'
import IbcGoV4IbcCoreClientV1 from './ibc-go/v4/ibc.core.client.v1'
import IbcGoV4IbcCoreConnectionV1 from './ibc-go/v4/ibc.core.connection.v1'
...
export default { 
  ...
  IbcGoV4IbcApplicationsTransferV1: load(IbcGoV4IbcApplicationsTransferV1, 'ibc.applications.transfer.v1'),
  IbcGoV4IbcCoreChannelV1: load(IbcGoV4IbcCoreChannelV1, 'ibc.core.channel.v1'),
  IbcGoV4IbcCoreClientV1: load(IbcGoV4IbcCoreClientV1, 'ibc.core.client.v1'),
  IbcGoV4IbcCoreConnectionV1: load(IbcGoV4IbcCoreConnectionV1, 'ibc.core.connection.v1'),
