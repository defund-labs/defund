...
const baseQueryLiquidityPoolRequest: object = { pool_id: 0 };
...
const baseQueryLiquidityPoolByReserveAccRequest: object = { reserve_acc: "" };
...
export const QueryLiquidityPoolByReserveAccRequest = {
  ...
  toJSON(message: QueryLiquidityPoolByReserveAccRequest): unknown {
    const obj: any = {};
    message.reserve_acc !== undefined &&
      (obj.reserve_acc = message.reserve_acc);
    return obj;
  },
...
const baseQueryLiquidityPoolBatchRequest: object = { pool_id: 0 };
...
const baseQueryPoolBatchSwapMsgsRequest: object = { pool_id: 0 };
...
const baseQueryPoolBatchSwapMsgRequest: object = { pool_id: 0, msg_index: 0 };
...
const baseQueryPoolBatchDepositMsgsRequest: object = { pool_id: 0 };
...
const baseQueryPoolBatchWithdrawMsgsRequest: object = { pool_id: 0 };
